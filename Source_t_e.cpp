...
//  result compilation error (перед указанием базового класса exception дл€ класса Exc
// ожидаетс€ квалификатор public; отсутствие главной функции main)
 */
...
/* class Exc : public exception                   // ¬ариант рабочего класса с конструтором Exc(const string& s)
{
    string str;
    public:
        Exc() :exception() {}
