...
{
    const char* text = "abcdef";                     // исправленно: добавлен квалификатор const к указателю char* text
    int i = 0;
    do
    {
        cout << text[++i];
 ...
 */
//result: ошибка компиляции (не константной переменной  присвоена константная строка и 
